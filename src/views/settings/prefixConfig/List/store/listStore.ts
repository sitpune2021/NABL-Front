...
import type {
    PrefixConfigListActions,
    PrefixConfigListState,
...
export const usePrefixConfigListStore = create<
    PrefixConfigListState & PrefixConfigListActions
>()(
    persist(
        (set) => ({
