...
import { apiGetLabMasterZones } from '@/services/ZoneService'

const useLabZones = (params: any) => {
    ...
    const swr = useSWR(
        ...
        ([_, queryParams]) => apiGetLabMasterZones<any, any>(queryParams),
        {
