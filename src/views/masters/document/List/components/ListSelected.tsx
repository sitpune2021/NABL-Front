...
const DocumentListSelected = () => {
    ...
    const handleConfirmDelete = () => {
        const newDocumentList = documentList.filter((document) => {
            return !selectedDocument.some(
        ...
        mutate(
            {
                ...
                total: documentListTotal - selectedDocument.length,
            },
            false,
        )
        setDeleteConfirmationOpen(false)
            ...
            >
                ...
                >
                    {selectedDocument.map((document) => (
                        <Tooltip key={document.id} title={document.name}>
                            <Avatar size={30} src={document.img} alt="" />
                        </Tooltip>
                    ))}
                </Avatar.Group> */}
                <div className="my-4">
...
export default DocumentListSelected
