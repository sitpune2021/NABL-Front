...
const InstrumentListSelected = () => {
    ...
    const handleConfirmDelete = () => {
        const newInstrumentList = instrumentList.filter((instrument) => {
            return !selectedInstrument.some(
            ...
            >
                ...
                >
                    {selectedInstrument.map((instrument) => (
                        <Tooltip key={instrument.id} title={instrument.name}>
                            <Avatar size={30} src={instrument.img} alt="" />
                        </Tooltip>
                    ))}
                </Avatar.Group> */}
                <div className="my-4">
