...
import {
    apiApproveCategories,
    apiGetPendingCategories,
} from '@/services/CategoriesService'
import { Category, GetCategoryListResponse } from '@/@types/category'
import { useCategoryList } from '../hooks/useList'

const CategoryPendingDrawer = () => {
    ...
    const fetchCategories = useCallback(async () => {
        try {
            ...
            const res =
                (await apiGetPendingCategories()) as GetCategoryListResponse
            const data = res?.data ?? []
    ...
    const handleApprove = useCallback(async () => {
        ...
        try {
            setLoading(true)
            await apiApproveCategories(selectedIds)
            mutate()
    ...
    }, [selectedIds, mutate, fetchCategories])
...
export default CategoryPendingDrawer
